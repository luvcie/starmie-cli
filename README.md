...
Not all commands are from Pokemon Showdown: `evyield`, `evspread`, `nature`, `ability`, `team`, `compare`, `counter`, `moves`, `sets`, and `randomquote` are custom additions of mine. :)
